...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/nuovocoin-cli.cpp \
           src/nuovocoin-tx.cpp \
           src/nuovocoin.cpp \
           src/db.cpp \
           ...
           src/qt/nuovocoin.cpp \
           src/qt/nuovocoinstrings.cpp \
...
RESOURCES += src/qt/nuovocoin.qrc src/qt/nuovocoin_locale.qrc

TRANSLATIONS += src/qt/locale/nuovocoin_bg.ts \
                src/qt/locale/nuovocoin_de.ts \
                src/qt/locale/nuovocoin_en.ts \
                src/qt/locale/nuovocoin_es.ts \
                src/qt/locale/nuovocoin_fi.ts \
                src/qt/locale/nuovocoin_fr.ts \
                src/qt/locale/nuovocoin_it.ts \
                src/qt/locale/nuovocoin_ja.ts \
                src/qt/locale/nuovocoin_pl.ts \
                src/qt/locale/nuovocoin_pt.ts \
                src/qt/locale/nuovocoin_ru.ts \
                src/qt/locale/nuovocoin_sk.ts \
                src/qt/locale/nuovocoin_sv.ts \
                src/qt/locale/nuovocoin_vi.ts \
                src/qt/locale/nuovocoin_zh_CN.ts \
                src/qt/locale/nuovocoin_zh_TW.ts
