Contributing to nuovocoin Core
============================

The nuovocoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the nuovocoin Core project, and is not to be
confused with overall nuovocoin Network Protocol consensus changes.

Whether a pull request is merged into nuovocoin Core rests with the project merge
...
Patches that change nuovocoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the nuovocoin consensus, it must have been
...
The project leader is the release manager for each nuovocoin Core release.
