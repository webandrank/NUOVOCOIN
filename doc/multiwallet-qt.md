...
In order to support loading of multiple wallets in nuovocoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is nuovocoin.cpp.
...
Changes to nuovocoin.cpp
----------------------
nuovocoin.cpp is the entry point into nuovocoin-qt, and as such, will require some minor modifications to provide hooks for
