nuovocoin Core version 2.3.0 is now available from:

  <https://github.com/nuovocoin-project/nuovocoin/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/nuovocoin-project/nuovocoin/issues>

Compatibility
==============

nuovocoin Core is extensively tested on multiple operating systems using
...
nuovocoin Core should also work on most other Unix-like systems but is not
...
[
  {
    ...
    winner: {
        address: addr,    (string) nuovocoin MN Address,
...
[
  {
    ...
    "addr": addr,      (string) Masternode nuovocoin address
...
nuovocoin Core now enables bloom filters by default to support SPV clients like mobile wallets. This feature can be disabled by using the `-peerbloomfilters` option on startup.
...
- #195 `aee05fe` [ZMQ] ZMQ integration for nuovocoin (Mrs-X)
...
### Tests and QA
- #191 `3a778c3` [Tests] Fix the unit test suite for use with nuovocoin (Fuzzbawls)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/nuovocoin-project-translations/).
