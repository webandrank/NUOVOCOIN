...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("nuovocoin Core nuovocoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  nuovocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nuovocoin transaction") + "\n" +
                               "  nuovocoin-tx [options] -create [commands]   " + _("Create hex-encoded nuovocoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nuovocoin transaction
