...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop nuovocoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "nuovocoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* nuovocoin features */
        {"nuovocoin", "masternode", &masternode, true, true, false},
        {"nuovocoin", "masternodelist", &masternodelist, true, true, false},
        {"nuovocoin", "mnbudget", &mnbudget, true, true, false},
        {"nuovocoin", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"nuovocoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"nuovocoin", "mnsync", &mnsync, true, true, false},
        {"nuovocoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"nuovocoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use nuovocoind, or the -server option to nuovocoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> nuovocoin-cli " + methodname + " " + args + "\n";
}
