...
/** Utility functions used by the nuovocoin Qt UI.
 */
namespace GUIUtil
{
...
// Render nuovocoin addresses in monospace font
...
// Parse "nuovocoin:" URI into recipient object, return true on successful parsing
