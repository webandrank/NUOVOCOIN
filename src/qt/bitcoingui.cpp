                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("NuovoCoin Wallet") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a nuovocoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nuovocoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About nuovocoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about nuovocoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for nuovocoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your nuovocoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified nuovocoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a nuovocoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the nuovocoin Core help message to get a list with possible nuovocoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("nuovocoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to nuovocoin network", "", count));
}
...
{
    QString strTitle = tr("nuovocoin Core"); // default title
